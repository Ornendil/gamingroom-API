...
if (!$db) {
    writeLog("[Error] Database connection failed on data fetch for admin panel.");
...
if (!$results) {
    writeLog("[Error] Database query failed on data fetch for admin panel.");
...
// writeLog("[Success] Data fetched successfully.");
